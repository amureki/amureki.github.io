...
Lead Engineer with 10+ years building reliable Python/Django platforms. OSS maintainer, prolific tinkerer always building something on the side, and a firm believer that great software is a team sport.
...
Building and evolving a B2B platform and related services together with a brilliant small team.

* Redesigned the data warehouse to use database views on a replica instead of loading the production database; drove org-wide data literacy through workshops — the team now runs on Metabase
...
Owned backend systems — a monolith (~150kloc) and microservices — powering core business processes.
...
* __Testing & quality__ — pytest, 90%+ coverage practices
* __Team leadership__ — hiring, onboarding, mentoring, process improvement
